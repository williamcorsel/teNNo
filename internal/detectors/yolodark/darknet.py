...
def performDetect(imagePath= CUR_DIR + "/data/dog.jpg", thresh= 0.25, configPath = CUR_DIR + "/cfg/yolov4.cfg", weightPath = CUR_DIR + "/yolov4.weights", metaPath= CUR_DIR + "/cfg/coco.data", showImage= True, makeImageOnly = False, initOnly= False):
    """
